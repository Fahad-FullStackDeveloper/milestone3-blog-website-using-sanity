...
const Footer = () => {
  return (
    <>
      {/* Footer container with text and padding */}
      <footer className=" body-font bg-white text-gray-700 shadow dark:bg-zinc-950 dark:text-white dark:shadow-zinc-700">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            {/* Brand name */}
            <span className="ml-3 text-xl text-gray-500">Your Brand Logo</span>
          </a>

          {/* Copyright text and link to the creator's profile */}
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            © 2025 NextWave Dev —
            {/* Link to the developer's Twitter profile */}
            <a
